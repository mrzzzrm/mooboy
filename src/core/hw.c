...
void hw_reset() {
#ifdef DEBUG
    lcd.mode_event[0].dbg_queued = 0;
    lcd.mode_event[1].dbg_queued = 0;
    lcd.mode_event[2].dbg_queued = 0;
    lcd.mode_event[3].dbg_queued = 0;
    lcd.vblank_line_event.dbg_queued = 0;
